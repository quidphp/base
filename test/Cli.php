...
class Cli extends Base\Test
{
    ...
    public static function trigger(array $data):bool
    {
        ...
        assert(strlen(Base\Cli::make(array(1,2,3),'red',null,'gray')) === 65);
        ...
        // prepareValue
        assert(strlen(Base\Cli::prepareValue(array('test'=>2,3,4))) === 52);
        
        // getPreset
        assert(Base\Cli::getPreset('pos') === array('green','underline',null));
        assert(Base\Cli::getPreset('asdas') === array());
        
        // setPreset
        Base\Cli::setPreset('james',array('black','bold','yellow'));
