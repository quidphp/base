...
class Html extends Base\Test
{
    ...
    final public static function trigger(array $data):bool
    {
        ...
        assert(Base\Html::xss("<script>alert('OK')</script><b onmouseover='alert('OK')'>ok</b>") === "alert('OK')<b onmouseover='alert('OK')'>ok</b>");
        assert(Base\Html::xss("<scr<script>ipt>alert('OK')</script>") === "alert('OK')");
        assert(Base\Html::xss("<b class='meh' id='OK' data-ok='WELL' onclick='WHAT!' ONMOUVE='ok'>ok</b>") === "<b class='meh' id='OK' data-ok='WELL' onclick='WHAT!' ONMOUVE='ok'>ok</b>");
        assert(Base\Html::xss("<b class='meh' id='OK' data-ok='WELL' ONCLICK='WHAT!'>ok</b>") === "<b class='meh' id='OK' data-ok='WELL' ONCLICK='WHAT!'>ok</b>");
        assert(Base\Html::xss("<b data-ba='WELL' onclick='WHAT!' class='meh' id='OK' data-ok='WELL' ONMOUVE='ok'>ok</b>") === "<b data-ba='WELL' onclick='WHAT!' class='meh' id='OK' data-ok='WELL' ONMOUVE='ok'>ok</b>"); // bogue ici, il retire tous les attributs après celui à enlever
        assert(Base\Html::xss("<img src='onboarding_01' alt='OK' />") === "<img src='onboarding_01' alt='OK' />");
        assert(Base\Html::xss("<div class='onyva'>On y va</div>") === "<div class='onyva'>On y va</div>");
