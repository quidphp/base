...
class Validate extends Base\Test
{
    ...
    final public static function trigger(array $data):bool
    {
        ...
        assert(Base\Validate::one('floatCast','2.3'));
        assert(Base\Validate::one('floatCastNotEmpty','2.3'));
        assert(!Base\Validate::one('floatCastNotEmpty','0'));
        assert(Base\Validate::one('intCast','0'));
        assert(Base\Validate::one('intCastNotEmpty',1));
