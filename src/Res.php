...
class Res extends Root
{
    ...
    public static function isRegularType($value):bool
    {
        $return = false;
    ...
    public static function isCurl($value):bool
    {
    ...
    public static function isFinfo($value):bool
    {
    ...
    public static function isContext($value):bool
    {
    ...
    public static function isFileUploaded($value):bool
    {
    ...
    public static function isFileVisible($value):bool
    {
    ...
    public static function isFilePathToUri($value):bool
    {
    ...
    public static function isFileParentExists($value):bool
    {
        return (File::isVisible($value))? true:false;
    }
    ...
    public static function isFileParentReadable($value):bool
    {
    ...
    public static function isFileParentWritable($value):bool
    {
    ...
    public static function isFileParentExecutable($value):bool
    {
    ...
    public static function isPhp($value):bool
    {
    ...
    public static function isPhpWritable($value):bool
    {
    ...
    public static function isPhpInput($value):bool
    {
        return (static::isPhp($value) && static::streamType($value) === 'Input')? true:false;
    }
    ...
    public static function isPhpOutput($value):bool
    {
    ...
    public static function isPhpTemp($value):bool
    {
    ...
    public static function isPhpMemory($value):bool
    {
    ...
    public static function isTimedOut($value):bool
    {
    ...
    public static function isBlocked($value):bool
    {
    ...
    public static function isSeekableTellable($value):bool
    {
    ...
    public static function isStart($value):bool
    {
    ...
    public static function canStat($value):bool
    {
    ...
    public static function canLocal($value):bool
    {
    ...
    public static function canMeta($value):bool
    {
        return (static::is($value) && !static::isContext($value) && static::isRegularType($value))? true:false;
    }
    ...
    public static function canContext($value):bool
    {
    ...
    public static function hasScheme($value):bool
    {
    ...
    public static function hasExtension($value):bool
    {
    ...
    // attention: certains types de resources, comme file peuvent être fonctionnelles sans avoir de scheme
    public static function isScheme(string $target,$value):bool
    {
    ...
    public static function isExtension($target,$value):bool
    {
        $return = false;
    ...
    public static function isFilePermission(string $type,$value,$user=null,$group=null):bool
    {
    ...
    public static function isOwner($value,$user=null):bool
    {
    ...
    public static function isGroup($value,$group=null):bool
    {
    ...
    public static function statValue($key,$value,bool $formatKey=false,bool $formatValue=false)
    {
        $return = null;
    ...
    public static function inode($value):?int
    {
    ...
    public static function permission($value,bool $format=false)
    {
    ...
    public static function dateAccess($value,bool $format=false)
    {
    ...
    public static function dateModify($value,bool $format=false)
    {
    ...
    public static function dateInodeModify($value,bool $format=false)
    {
    ...
    public static function responseMeta($value,bool $contextOption=true):?array
    {
        $return = null;
    ...
    public static function kind($value):?string
    {
        $return = null;
    ...
    public static function metaValue(string $key,$value)
    {
        $return = null;
        $meta = static::meta($value);
    ...
    public static function mode($value,bool $removeBinary=false):?string
    {
        $return = null;
    ...
    public static function wrapperType($value):?string
    {
    ...
    public static function wrapperData($value):?array
    {
    ...
    public static function streamType($value):?string
    {
    ...
    public static function unreadBytes($value):?int
    {
    ...
    public static function headers($value):?array
    {
        $return = null;
    ...
    public static function path($value,bool $contextOption=false):?string
    {
        $return = null;
    ...
    // ne fonctionne pas avec les directoires
    // fonctionne avec les ressources phpWritable
    public static function pathinfo($value):?array
    {
        $return = null;
    ...
    public static function size($value,bool $format=false)
    {
        $return = null;
    ...
    public static function mime($value,bool $charset=true,bool $contextOption=false):?string
    {
    ...
    // méthode protégé
    protected static function openFromKind(string $value,string $kind,array $option)
    {
        $return = null;
    ...
    public static function openKind(string $value):?string
    {
        $return = null;
    ...
    public static function http(string $value,?array $post=null,$header=null):?array
    {
        $return = null;
    ...
    public static function curl(string $value,bool $exec=false,$post=null,$header=null,?array $option=null)
    {
    ...
    public static function context($value,string $kind)
    {
    ...
    public static function curlExec($value,bool $close=true):?array
    {
        $return = null;
    ...
    public static function curlInfo($value):?array
    {
        $return = null;
    ...
    public static function position($value):?int
    {
        $return = null;
        $kind = static::kind($value);
    ...
    public static function seek($seek=0,$value,?int $type=SEEK_SET,?array $option=null):bool
    {
        $return = false;
    ...
    // méthode protégé
    protected static function seekDir(int $position,$value,bool $rewind=true,bool $dot=false):bool
    {
        $return = false;
    ...
    public static function seekCurrent($seek,$value,?array $option=null):bool
    {
    ...
    public static function seekEnd($seek=0,$value,?array $option=null):bool
    {
    ...
    // support pour directoire
    public static function seekRewind($value):bool
    {
        $return = false;
        $kind = static::kind($value);
    ...
    public static function lock($value,bool $exclusive=false):bool
    {
        $return = false;
    ...
    public static function unlock($value):bool
    {
        $return = false;
    ...
    public static function flush($value):bool
    {
        $return = false;
    ...
    public static function lineRef($value,$offset=true,$length=true,int &$i,?array $option=null)
    {
        $return = null;
    ...
    public static function get($value,$seek=true,$length=true,?array $option=null)
    {
        $return = null;
        $close = false;
    ...
    public static function read($seek,$length,$value,?array $option=null)
    {
        $return = null;
    ...
    // retourne vrai si le content a été écrit en entier, sinon retourne un int pour dire le nombre d'octets écrit
    public static function writeStream(string $content,$value,?array $option=null)
    {
        $return = false;
    ...
    public static function toFile($path,$value,?array $option=null)
    {
        $return = null;
    ...
    public static function pathToUriOrBase64($value):?string
    {
    ...
    public static function touch($value):bool
    {
    ...
    public static function rename($target,$value)
    {
        $return = null;
    ...
    // retourne null ou la resource du nouveau fichier
    public static function changeDirname($dirname,$value)
    {
        $return = null;
        $path = static::path($value);
    ...
    // retourne null ou la resource du nouveau fichier
    public static function changeBasename(string $basename,$value)
    {
        $return = null;
        $path = static::path($value);
    ...
    // retourne null ou la resource du nouveau fichier
    public static function changeExtension(string $extension,$value)
    {
        $return = null;
        $path = static::path($value);
    ...
    // retourne null ou la resource du nouveau fichier
    public static function removeExtension($value)
    {
        $return = null;
        $path = static::path($value);
    ...
    public static function moveUploaded($target,$value)
    {
        $return = null;
    ...
    public static function copy($to,$value):?bool
    {
    ...
    public static function copyInDirname(string $basename,$value):?bool
    {
    ...
    public static function copyWithBasename($dirname,$value):?bool
    {
    ...
    public static function unlink($value):bool
    {
    ...
    public static function close($value):bool
    {
        $return = false;
        $kind = static::kind($value);
