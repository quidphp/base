...
class En extends Base\Config
{
    ...
    protected static array $config = [
        ...
        'validate'=>[
            ...
            'intCast'=>'Must be an whole number',
            'intCastNotEmpty'=>'Must be an whole number not empty',
            'floatCast'=>'Must be a decimal number',
            ...
            'uriRelative'=>'Must be a relative uri (/xyz)',
            ...
            'uriPath'=>'Must be a valid uri path',
            'uri'=>'Must be a valid relative or absolute uri',
