...
class Fr extends Base\Config
{
	...
	public static $config = [
		...
		'validate'=>[
			...
			'numberWhole'=>'Doit être un chiffre entier',
			'numberWholeNotEmpty'=>'Doit être un chiffre entier non vide',
			'numberDecimal'=>'Doit être un chiffre avec décimal',
			...
			'uriRelative'=>'Doit être une uri relative',
			...
			'path'=>'Doit être un chemin valide (A-a 0-9 _-./*)',
