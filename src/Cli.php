...
class Cli extends Root
{
    ...
    public static $config = [
        ...
        'foreground'=>array( // code pour couleur avant-plan
            'black'=>'0;30',
            'darkGray'=>'1;30',
            'red'=>'0;31',
            'lightRed'=>'1;31',
            ...
            'lightGray'=>'0;37',
            'white'=>'1;37'),
        'background'=>array( // code pour couleur arrière-plan
            'black'=>40,
            'red'=>41,
            'green'=>42,
            'yellow'=>43,
            ...
            'cyan'=>46,
            'gray'=>47),
        'style'=>array( // code pour des styles
            'normal'=>0,
            'bold'=>1,
            'dim'=>2,
            'italic'=>3,
            ...
            'reverse'=>7,
            'invisible'=>8),
        'preset'=>array( // règle de styles pour certaines presets
            'pos'=>array('green','underline',null),
            'neg'=>array('red','underline',null),
            'neutral'=>array('black',null,'gray'))
    ];
    ...
    {
        return static::$config['preset'][$value] ?? array();
    }
