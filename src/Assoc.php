...
class Assoc extends Root
{
    ...
    final public static function exist($key,$assoc,?array $option=null):bool
    {
    ...
    final public static function exists(array $keys,$assoc,?array $option=null):bool
    {
    ...
    final public static function prepend(...$values):array
    {
    ...
    final public static function count($assoc,bool $recursive=false,?array $option=null):int
    {
    ...
    final public static function index($index,$assoc,?array $option=null)
    {
    ...
    final public static function indexes(array $indexes,$assoc,?array $option=null):array
    {
    ...
    final public static function get($key,$assoc,?array $option=null)
    {
    ...
    final public static function gets(array $keys,$assoc,?array $option=null):array
    {
    ...
    final public static function set($key,$value,$assoc,?array $option=null):array
    {
    ...
    final public static function sets(array $values,$assoc,?array $option=null):array
    {
    ...
    final public static function unset($key,$assoc,?array $option=null):array
    {
    ...
    final public static function unsets(array $keys,$assoc,?array $option=null):array
    {
    ...
    final public static function slice($start,$end,$assoc,?array $option=null):array
    {
    ...
    final public static function sliceIndex(int $offset,?int $length,$assoc,?array $option=null):array
    {
    ...
    final public static function splice($start,$end,$assoc,$replace=null,?array $option=null):array
    {
    ...
    final public static function spliceIndex(int $offset,?int $length,$assoc,$replace=null,?array $option=null):array
    {
    ...
    final public static function spliceFirst($assoc,$replace=null,?array $option=null):array
    {
    ...
    final public static function spliceLast($assoc,$replace=null,?array $option=null):array
    {
    ...
    final public static function insert($start,$replace,$assoc,?array $option=null):array
    {
    ...
    final public static function insertIndex(int $offset,$replace,$assoc,?array $option=null):array
    {
    ...
    final public static function keysStart(string $str,$assoc,?array $option=null):array
    {
    ...
    final public static function keysEnd(string $str,$assoc,?array $option=null):array
    {
